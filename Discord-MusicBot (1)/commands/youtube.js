...
module.exports = {
    name: "youtube",
    description: "Inicia um sessão do Youtube Togheter",
    usage: "",
    permissions: {
    ...
    run: async (client, message, args, { GuildDB }) => {
        ...
        if(!message.member.voice.channel.permissionsFor(message.guild.me).has("CREATE_INSTANT_INVITE"))return client.sendTime(message.channel, "❌ | **O bot não tem permissão para criar convites!**");
        ...
        .setColor("#FF0000")
        .setDescription(`
Usando o **YouTube Together** você pode assistir ao youtuve com seus amigos em um canal de voz. Clique em *Entre no YouTube Together* para participar!

__**[Entre no YouTube Together](https://discord.com/invite/${Invite.code})**__

⚠ **Nota:** Funciona apenas em computadores
`)
